...
> = {
  ...
  "leave-management": {
   ...
   "payroll-query": {
    agentId: "c00330ce-54c8-4b7d-88be-c0b6ea88a624",
    name: "Payroll Query Agent",
    description: "I can help you with payroll inquiries, salary information, tax deductions, and payment schedules.",
    capabilities: ["Payroll Information", "Salary Queries", "Tax Deductions", "Payment Schedules"],
    icon: "DollarSign",
    color: "bg-blue-500",
  },
  "benefits-query": {
